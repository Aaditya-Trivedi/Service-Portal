<?php 
    ...
    if($_SESSION['is_login'])
    {
        ...
        {
            $sql = "SELECT r_password FROM ragistration_tb WHERE r_email = '$rEmail'";
            ...
            if (isset($_REQUEST['changepassword'])) 
            {
                ...
                {   
                    ...
                    {   
                        ...
                        $sql = "UPDATE ragistration_tb SET r_password = '$rNewPassword' WHERE r_email = '$rEmail'";
            ...
            <nav class="col-sm-2 sidebar py-5 bg-outline-dark shadow">
                <div class="sidebar-sticky">
                    <ul class="nav-flex-column nav-underline ">
                        ...
                        <li class="nav-item list-group-item mt-5">
                            <a href="ChangePassword.php" class="nav-link active "><!--bg-dark-->
                            <!--<i class="fas fa-user "></i>-->
