...
else
{
    ...
    if(isset($_REQUEST['rSingup']))
    {
        ...
        $sql = "SELECT technician_email FROM technician_tb WHERE technician_email = '".$_REQUEST['rEmail']."'";
        ...
        {//Registering Data
            ...
            $sql = "INSERT INTO technician_tb(technician_name,technician_mobile,technician_email,technician_password) VALUES('$rName','$rMobile','$rEmail','$rPassword')";
        ...
        <div class = "col-md-6 offset-3 ">
            <form action="" class="shadow-lg p-4 " method="post" >
                ...
                <div class="form-group">
                    ...
                    <label for="mobile" class="font-weight-bold pl-2">Mobile</label>
                    <input type="text" class="form-control" placeholder="Mobile Number" name="rMobile" onkeypress="isInputNumber(event)" required>
                </div>
                ...
                <div class="d-grid gap-2">
                    <Button type="submit" class="btn btn-info mt-3 shadow-sm font-weight-bold" name="rSingup" >Add Technician</Button>
                </div>
                <?php if(isset($smsg)){echo $smsg;}?>
                <div>
                    <a href="Technicians.php" class="btn btn-secondary mt-3">BACK</a>
